...
*   **Role**: Handles the Graphical User Interface (GUI) using LVGL. Receives telemetry data from the CAN bus and renders smooth 60fps animations on an 800x480 RGB LCD.
